...
import (
	...
	_ "github.com/lib/pq"
	"github.com/youremine2493/Dalaran/config"
...
var (
	...
	DROP_RATE         = utils.ParseFloat("3.0")
	EXP_RATE          = utils.ParseFloat("2.0")
	DEFAULT_EXP_RATE  = utils.ParseFloat("2.0")
	DEFAULT_DROP_RATE = utils.ParseFloat("3.0")
)
...
func getAll() error {
	...
	callBacks := []func() error{getAllDrops, getScripts, getHaxCodes, getHTItems, getProductions, getCraftItem, getAdvancedFusions, getItemMeltings, getGates,
		getStackables, getAllItems, getSkillInfos, getGamblingItems, getJobPassives, getItemSet, getBuffIcons, getBuffInfections, getExps, getAllSavePoints,
